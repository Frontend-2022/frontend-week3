        ...
        <div className="scheduleCSS">
            <div className="schedule__header">
                ...
                <div className="schedule__header-form">
                    <FormGroup>
                        <Label for="exampleSelect">Tuần học</Label>
                        <Input type="select" name="select" id="exampleSelect" >
                            <option >from <span style={{color: 'red'}}>xx/yy/zzzz</span> to <span >xx/yy/zzzz</span></option>
                ...
                <div className="schedule__header-button1">
                    <BiChevronsRight/>
                </div>
            </div>
